...
export default {
  ...
  props: {
    src: createEditorInputProp({
      label: '图片链接',
      defaultValue: 'https://p26-passport.byteacctimg.com/img/user-avatar/a12234807eb14a36c78896ed4eab6952~300x300.image',
    }),
    width: createEditorInputProp({ label: '宽度', defaultValue: 300 }),
    height: createEditorInputProp({ label: '高度', defaultValue: 300 }),
